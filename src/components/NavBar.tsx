...
import {
  ...
  MoreHorizontal, X, Settings, Globe2, Search, Activity,
  type LucideIcon,
} from 'lucide-react'
    ...
    <div className="mx-1 mt-4">
      <div className="bg-gradient-to-br from-brand-50 to-violet-50 border border-brand-100 rounded-2xl p-3.5">
        <div className="flex items-center gap-1.5 mb-2.5">
          ...
          <span className="text-[11px] font-bold text-brand-900 leading-none">Built for deliberate vocabulary growth</span>
        </div>
        <ul className="space-y-1.5">
          {[
            'Repeated exposure, not cramming',
            'Focus portfolio for what matters now',
            'Quick review or deep deliberate practice',
          ].map((text) => (
