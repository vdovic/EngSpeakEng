...
export function createSeedData(): VocabItem[] {
  ...
  return [
    makeItem({
      ...
      type: 'word',
      status: 'activation',
      translations: { uk: "пом'якшувати", pl: 'łagodzić', ru: 'смягчать' },
    ...
    makeItem({
      ...
      type: 'word',
      status: 'learning',
      translations: { uk: 'громіздкий', pl: 'uciążliwy', ru: 'громоздкий' },
    ...
    makeItem({
      ...
      type: 'phrase',
      status: 'stable',
      translations: { uk: 'висловити занепокоєння', pl: 'zgłosić zastrzeżenie', ru: 'высказать озабоченность' },
    ...
    makeItem({
      ...
      type: 'chunk',
      status: 'learning',
      translations: { uk: 'Я маю на увазі, що…', pl: 'Chodzi mi o to, że…', ru: 'Я имею в виду, что…' },
    ...
    makeItem({
      ...
      type: 'phrase',
      status: 'activation',
      translations: { uk: 'дійти згоди щодо', pl: 'uzgodnić', ru: 'согласовать' },
    ...
    makeItem({
      ...
      type: 'word',
      status: 'mastered',
      translations: { uk: 'зацікавлена сторона', pl: 'interesariusz', ru: 'заинтересованная сторона' },
    ...
    makeItem({
      ...
      type: 'word',
      status: 'inbox',
      translations: { uk: 'ресурси / можливості', pl: 'możliwości / przepustowość', ru: 'ресурсы / пропускная способность' },
    ...
    makeItem({
      ...
      type: 'phrase',
      status: 'inbox',
      translations: { uk: 'вдосконалювати ітеративно', pl: 'iterować', ru: 'итерировать' },
